...
name: animejs
description: >-
  中文说明：为HyperFrames编写可控、可定位且可稳定渲染的Anime.js动画。
  原始触发说明：Anime.js adapter patterns for HyperFrames. Use when writing Anime.js animations or timelines inside HyperFrames compositions, registering animations on window.__hfAnime, making Anime.js seek-driven and deterministic, or translating Anime.js examples into render-safe HyperFrames HTML.
---
