...
description: >-
  中文说明：创建可编辑的Excalidraw流程图、架构图和概念关系图。
  原始触发说明：Create Excalidraw diagram JSON files that make visual arguments. Use when the user wants to visualize workflows, architectures, or concepts.
---
